...
void QuaternionDFromEuler(QuaternionD* result, const float pitch, const float yaw, const float roll)
{
...
void QuaternionDMultiply(QuaternionD* result, QuaternionD* q1, QuaternionD* q2)
{
    ...
    memcpy(result, &temp, sizeof(QuaternionD));
}
