...
// GLOBAL: MIDIJAM 0x45EACC
GLfloat GUITAR_FRET_HEIGHTS[25] = {
    0.0, 0.0, -1.3, -3.3199999, -5.0, -6.7020001, -8.25, -9.7019997, -11.091,
    -12.403, -13.667, -14.848, -15.952, -16.98, -17.993, -18.938, -19.834,
    -20.702, -21.459, -22.209, -22.952, -23.632, -24.25, -24.855, 0.0
};
    ...
    for (i = 0; i < g_guitarCount; ++i) {
        if (g_guitar[i].isActive == 1) {
            ...
            if (g_guitar[i].field_2C4[0] <= 1 || g_guitar[i].field_2C4[0] > 23) {
                ...
                glPushMatrix();
                glTranslatef(0.0, GUITAR_FRET_HEIGHTS[g_guitar[i].field_2C4[0]], 0.0);
                g_guitarNoteFinger_ms3d->Render();
                glPopMatrix();
                glScalef(1.0, GUITAR_FRET_HEIGHTS_AS_PERCENT[g_guitar[i].field_2C4[0] - 1], 1.0);
                g_guitarStringLow_ms3d->Render();
            }
            glPopMatrix();
            glPushMatrix();
            ...
            if (g_guitar[i].field_2C4[1] <= 1 || g_guitar[i].field_2C4[1] > 23) {
                ...
                glPushMatrix();
                glTranslatef(0.0, GUITAR_FRET_HEIGHTS[g_guitar[i].field_2C4[1]], 0.0);
                g_guitarNoteFinger_ms3d->Render();
                glPopMatrix();
                glScalef(1.0, GUITAR_FRET_HEIGHTS_AS_PERCENT[g_guitar[i].field_2C4[1] - 1], 1.0);
                g_guitarStringLow_ms3d->Render();
            }
            glPopMatrix();
            glPushMatrix();
            ...
            if (g_guitar[i].field_2C4[2] <= 1 || g_guitar[i].field_2C4[2] > 23) {
                ...
                glPushMatrix();
                glTranslatef(0.0, GUITAR_FRET_HEIGHTS[g_guitar[i].field_2C4[2]], 0.0);
                g_guitarNoteFinger_ms3d->Render();
                glPopMatrix();
                glScalef(1.0, GUITAR_FRET_HEIGHTS_AS_PERCENT[g_guitar[i].field_2C4[2] - 1], 1.0);
                g_guitarStringLow_ms3d->Render();
            }
            glPopMatrix();
            glPushMatrix();
            ...
            if (g_guitar[i].field_2C4[3] <= 1 || g_guitar[i].field_2C4[3] > 23) {
                ...
                glPushMatrix();
                glTranslatef(0.0, GUITAR_FRET_HEIGHTS[g_guitar[i].field_2C4[3]], 0.0);
                g_guitarNoteFinger_ms3d->Render();
                glPopMatrix();
                glScalef(1.0, GUITAR_FRET_HEIGHTS_AS_PERCENT[g_guitar[i].field_2C4[3] - 1], 1.0);
                g_guitarStringHigh_ms3d->Render();
            }
            glPopMatrix();
            glPushMatrix();
            ...
            if (g_guitar[i].field_2C4[4] <= 1 || g_guitar[i].field_2C4[4] > 23) {
                ...
                glPushMatrix();
                glTranslatef(0.0, GUITAR_FRET_HEIGHTS[g_guitar[i].field_2C4[4]], 0.0);
                g_guitarNoteFinger_ms3d->Render();
                glPopMatrix();
                glScalef(1.0, GUITAR_FRET_HEIGHTS_AS_PERCENT[g_guitar[i].field_2C4[4] - 1], 1.0);
                g_guitarStringHigh_ms3d->Render();
            }
            glPopMatrix();
            glPushMatrix();
            ...
            if (g_guitar[i].field_2C4[5] <= 1 || g_guitar[i].field_2C4[5] > 23) {
                ...
                glPushMatrix();
                glTranslatef(0.0, GUITAR_FRET_HEIGHTS[g_guitar[i].field_2C4[5]], 0.0);
                g_guitarNoteFinger_ms3d->Render();
                glPopMatrix();
                glScalef(1.0, GUITAR_FRET_HEIGHTS_AS_PERCENT[g_guitar[i].field_2C4[5] - 1], 1.0);
                g_guitarStringHigh_ms3d->Render();
            }
            glPopMatrix();
            glPushMatrix();
            ...
            if (g_guitar[i].field_2C4[0] <= 1 || g_guitar[i].field_2C4[0] > 23) {
                ...
                y = 1.0 - GUITAR_FRET_HEIGHTS_AS_PERCENT[g_guitar[i].field_2C4[0] - 1];
                glScalef(1.0, y, 1.0);
                g_guitarLowStringBottomX_ms3d[g_vibratingString_frame]->Render();
            }
            glPopMatrix();
            ...
            if (g_guitar[i].field_2C4[1] <= 1 || g_guitar[i].field_2C4[1] > 23) {
                ...
                ya = 1.0 - GUITAR_FRET_HEIGHTS_AS_PERCENT[g_guitar[i].field_2C4[1] - 1];
                glScalef(1.0, ya, 1.0);
                g_guitarLowStringBottomX_ms3d[g_vibratingString_frame]->Render();
            }
            glPopMatrix();
            ...
            if (g_guitar[i].field_2C4[2] <= 1 || g_guitar[i].field_2C4[2] > 23) {
                ...
                yb = 1.0 - GUITAR_FRET_HEIGHTS_AS_PERCENT[g_guitar[i].field_2C4[2] - 1];
                glScalef(1.0, yb, 1.0);
                g_guitarLowStringBottomX_ms3d[g_vibratingString_frame]->Render();
            }
            glPopMatrix();
            ...
            if (g_guitar[i].field_2C4[3] <= 1 || g_guitar[i].field_2C4[3] > 23) {
                if (g_guitar[i].field_2C4[3] == 1)
                    g_guitarHighStringBottomX_ms3d[g_vibratingString_frame]->Render();
            }
            else {
                yc = 1.0 - GUITAR_FRET_HEIGHTS_AS_PERCENT[g_guitar[i].field_2C4[3] - 1];
                glScalef(1.0, yc, 1.0);
                g_guitarHighStringBottomX_ms3d[g_vibratingString_frame]->Render();
            }
            glPopMatrix();
            ...
            if (g_guitar[i].field_2C4[4] <= 1 || g_guitar[i].field_2C4[4] > 23) {
                ...
                yd = 1.0 - GUITAR_FRET_HEIGHTS_AS_PERCENT[g_guitar[i].field_2C4[4] - 1];
                glScalef(1.0, yd, 1.0);
                g_guitarHighStringBottomX_ms3d[g_vibratingString_frame]->Render();
            }
            glPopMatrix();
            ...
            if (g_guitar[i].field_2C4[5] <= 1 || g_guitar[i].field_2C4[5] > 23) {
                ...
                ye = 1.0 - GUITAR_FRET_HEIGHTS_AS_PERCENT[g_guitar[i].field_2C4[5] - 1];
                glScalef(1.0, ye, 1.0);
                g_guitarHighStringBottomX_ms3d[g_vibratingString_frame]->Render();
            }
            glPopMatrix();
