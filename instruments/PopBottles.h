...
#ifndef MIDIJAM_POPBOTTLES_H
#define MIDIJAM_POPBOTTLES_H
...
// ---------------------------------------------------------------------------
// PopBottlesState — per-instance state
// sizeof = 0xXXXX
// ---------------------------------------------------------------------------
struct PopBottlesState {
    __int16 isActive;
    __int16 timeToLive;
    int field_4[12];
    int field_34[12];
...
static_assert(sizeof(PopBottlesState) == 0xD354, "PopBottlesState layout mismatch");

// ---------------------------------------------------------------------------
// Globals
// ---------------------------------------------------------------------------
DECL_INST_DS(popBottles, PopBottlesState)

extern Ms3dBundle* g_popBottle_ms3d;
extern Ms3dBundle* g_popBottleMiddle_ms3d;
extern Ms3dBundle* g_popBottlePop_ms3d;
extern Ms3dBundle* g_popBottleLabel_ms3d;
