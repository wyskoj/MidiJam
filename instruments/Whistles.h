...
#ifndef MIDIJAM_WHISTLES_H
#define MIDIJAM_WHISTLES_H
...
// ---------------------------------------------------------------------------
// WhistlesState — per-instance state
// sizeof = 0xXXXX
// ---------------------------------------------------------------------------
struct WhistlesState {
    __int16 isActive;
    __int16 timeToLive;
    int field_4[12];
    int field_34[12];
...
static_assert(sizeof(WhistlesState) == 0xD354, "WhistlesState layout mismatch");

// ---------------------------------------------------------------------------
// Globals
// ---------------------------------------------------------------------------
DECL_INST_DS(whistles, WhistlesState)

extern Ms3dBundle* g_whistle_ms3d;
