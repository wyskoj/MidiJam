...
BOOL LoadHwfFonts(FILE* hwfStream, char* hwfAppendixPtr, unsigned int hwfAppendixEntriesCount);
...
void RenderTextWithShadow(int positionX, int positionY, short shadowShiftX, short shadowShiftY, char* text, int fontIndex, GLfloat scaleX, GLfloat scaleY);
